...
index_expr = (pp.Suppress('@') + num_expr + '[' + pp.Word(pp.nums) + ']').add_parse_action(lambda n: pita.PitaIndexExpr(n[0], int(n[2])))

single_num_expr <<= cond | let | arith | func_call | var | index_expr
